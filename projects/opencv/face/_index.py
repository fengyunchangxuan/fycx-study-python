...
parser.add_argument('--face_cascade', help='Path to face cascade.',
                    default='C:/Program Files/opencv/sources/data/haarcascades/haarcascade_frontalface_alt.xml')
parser.add_argument('--eyes_cascade', help='Path to eyes cascade.',
                    default='C:/Program Files/opencv/sources/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml')
parser.add_argument(
